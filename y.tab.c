...
{
       0,    86,    86,    88,    93,    94,    99,   100,   103,   105,
     108,   111,   113,   117,   118,   121,   122,   123,   124,   125,
     126,   127,   130,   131,   132,   133,   134,   135,   136,   139,
     143,   150,   151,   152,   153,   156,   157,   160,   163,   166,
     167,   170,   171,   172,   173,   174,   175,   179,   180,   181,
     182,   183
};
#endif
...
#line 103 "myml.y"
                        {(yyval.val_string) = (yyvsp[-2].val_string); add_symbol_value((yyvsp[-2].val_string),offset); printf("/* Value of %s stored at stack index fp+%d*/\n", (yyvsp[-2].val_string), offset++);}
#line 1349 "y.tab.c"
    break;
...
#line 108 "myml.y"
                                {(yyval.val_string) = (yyvsp[-3].val_string); printf("/* Function %s defined in separated file */\n", (yyvsp[-3].val_string)); file_out_function = fopen("test.fp", "w"); stdout = file_out_function; printf("void call_%s(){\n", (yyvsp[-3].val_string));}
#line 1361 "y.tab.c"
    break;
