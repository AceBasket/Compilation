...
{
       0,    62,    62,    64,    69,    70,    75,    76,    79,    82,
      85,    88,    89,    93,    94,    97,    98,    99,   100,   101,
     102,   103,   106,   107,   108,   109,   110,   111,   112,   115,
     119,   122,   123,   124,   125,   128,   129,   132,   135,   136,
     139,   140,   141,   142,   143,   144,   148,   148,   148,   148,
     148
};
#endif
...
#line 1383 "y.tab.c"
  ...
  case 25: /* atom_exp: ID  */
#line 109 "myml.y"
     { get_symbol_value((yyvsp[0].val_string)); printf("LOADI %s\n", (yyvsp[0].val_string));}
#line 1389 "y.tab.c"
    break;
